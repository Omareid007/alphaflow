...
const providerPolicies: Record<string, ProviderPolicy> = {
  ...
  claude: {
    ...
    maxTokensPerMinute: envInt("CLAUDE_TOKEN_LIMIT_PER_MIN", 40000),
    maxRequestsPerDay: envInt("CLAUDE_RATE_LIMIT_PER_DAY", 5000),
  ...
  openrouter: {
    ...
    maxTokensPerMinute: envInt("OPENROUTER_TOKEN_LIMIT_PER_MIN", 100000),
    maxRequestsPerDay: envInt("OPENROUTER_RATE_LIMIT_PER_DAY", 5000),
  ...
  deepseek: {
    ...
    maxTokensPerMinute: envInt("DEEPSEEK_TOKEN_LIMIT_PER_MIN", 60000),
    maxRequestsPerDay: envInt("DEEPSEEK_RATE_LIMIT_PER_DAY", 10000),
