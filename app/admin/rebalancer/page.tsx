      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-muted-foreground">
            Rebalancing policies and triggers
          </p>
        </div>
          ...
          {activePolicies.length === 0 ? (
            <div className="py-8 text-center">
              <p className="text-muted-foreground">
                No active allocation policies. Enable policies in the Allocation
                page.
              </p>
            </div>
          ) : (
                ...
                >
                  <div className="flex-1">
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                      Frequency: {policy.rebalanceFrequency} • Max Position:{" "}
      ...
      <Card>
        ...
        <CardContent>
          {runs.length === 0 ? (
            <div className="py-8 text-center">
              <p className="text-muted-foreground">
                No rebalance runs yet. Trigger one above or enable a policy.
              </p>
            </div>
          ) : (
            <div className="space-y-3">
