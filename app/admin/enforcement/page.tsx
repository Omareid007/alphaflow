...
export default function EnforcementPage() {
  ...
  const getSeverityFromType = (ruleType: string) => {
    if (ruleType.includes("loss") || ruleType.includes("critical"))
      return "critical";
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-muted-foreground">
            Risk rules and guardrails ({rules.length} total)
          </p>
        </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="position_limit">
                        Position Limit
                      </SelectItem>
                      <SelectItem value="daily_loss">
                        Daily Loss Limit
                      </SelectItem>
          ...
          {rules.length === 0 ? (
            <div className="py-12 text-center">
              <p className="text-muted-foreground">
                No enforcement rules found. Create one to get started.
              </p>
            </div>
          ) : (
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <p className="mt-1 text-sm text-muted-foreground">
                        {rule.condition?.scope || "portfolio"} •{" "}
                        {rule.ruleType.replace("_", " ")} • Threshold:{" "}
                        {rule.threshold}
