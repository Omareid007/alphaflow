...
export const config = {
  // Environment
  env: getEnvString("NODE_ENV", "development") as
    | "development"
    | "production"
    | "test",
  ...
  alpaca: {
    ...
    baseUrl: getEnvStringOptional(
      "ALPACA_BASE_URL",
      "https://paper-api.alpaca.markets"
    ),
    dataUrl: getEnvStringOptional(
      "ALPACA_DATA_URL",
...
export function validateConfig(): void {
  ...
  if (
    config.isProduction &&
    config.session.secret === "default-secret-change-in-production"
  ) {
