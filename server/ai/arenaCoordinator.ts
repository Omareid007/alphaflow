...
${contextSummary}`;
      ...
      const request: LLMGatewayRequest = {
        ...
        traceId,
        systemPrompt,
        userPrompt: `Analyze ${symbols.join(", ")} and provide your ${role} perspective. Be specific and data-driven. Return valid JSON only. Do not include any text outside the JSON object.`,
