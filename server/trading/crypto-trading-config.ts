 ...
 */
export const CRYPTO_CORRELATION_MATRIX: Record<
  string,
...
> = {
  ...
  "AVAX/USD": { "BTC/USD": 0.7, "ETH/USD": 0.73, "SOL/USD": 0.82 },
  "LINK/USD": { "BTC/USD": 0.65, "ETH/USD": 0.72, "SOL/USD": 0.7 },
  "UNI/USD": { "BTC/USD": 0.68, "ETH/USD": 0.8, "SOL/USD": 0.75 },
  "AAVE/USD": { "BTC/USD": 0.67, "ETH/USD": 0.82, "SOL/USD": 0.74 },
  "MATIC/USD": { "BTC/USD": 0.72, "ETH/USD": 0.76, "SOL/USD": 0.79 },
  "DOT/USD": { "BTC/USD": 0.68, "ETH/USD": 0.7, "SOL/USD": 0.76 },
...
export function checkCorrelationRisk(
  ...
  for (const position of existingPositions) {
    const correlation = getCryptoCorrelation(
      newSymbolNormalized,
      position.symbol
    );
 ...
 */
export function validateCryptoTradable(symbol: string): {
  tradable: boolean;
  reason?: string;
} {
  const normalized = normalizeCryptoSymbol(symbol);
