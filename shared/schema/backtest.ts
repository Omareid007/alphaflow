 ...
 */
export const backtestTradeEvents = pgTable(
 ...
 * @relation backtestRuns - Parent backtest run (cascade delete)
 */
export const backtestEquityCurve = pgTable(
...
export const insertBacktestTradeEventSchema = createInsertSchema(
  backtestTradeEvents
).omit({
  id: true,
});

export const insertBacktestEquityCurveSchema = createInsertSchema(
  backtestEquityCurve
).omit({
  id: true,
});
...
export type InsertBacktestTradeEvent = z.infer<
  typeof insertBacktestTradeEventSchema
>;
export type BacktestTradeEvent = typeof backtestTradeEvents.$inferSelect;

export type InsertBacktestEquityCurve = z.infer<
  typeof insertBacktestEquityCurveSchema
>;
