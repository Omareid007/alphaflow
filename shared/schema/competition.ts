 ...
 */
export const competitionRuns = pgTable(
  "competition_runs",
  {
    id: varchar("id")
      .primaryKey()
...
export const competitionScores = pgTable(
  "competition_scores",
  {
    ...
    runId: varchar("run_id")
      .references(() => competitionRuns.id, { onDelete: "cascade" })
      .notNull(),
    traderProfileId: varchar("trader_profile_id")
      .references(() => traderProfiles.id, { onDelete: "cascade" })
      .notNull(),
...
export const insertTraderProfileSchema = createInsertSchema(
  traderProfiles
).omit({
  id: true,
  createdAt: true,
...
export const insertCompetitionRunSchema = createInsertSchema(
  competitionRuns
).omit({
  id: true,
  createdAt: true,
...
export const insertCompetitionScoreSchema = createInsertSchema(
  competitionScores
).omit({
  id: true,
  snapshotAt: true,
...
export type InsertCompetitionScore = z.infer<
  typeof insertCompetitionScoreSchema
>;
