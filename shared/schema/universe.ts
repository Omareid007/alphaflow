 ...
 */
export const universeAssets = pgTable(
  "universe_assets",
  {
    id: varchar("id")
      .primaryKey()
 ...
 */
export const universeLiquidityMetrics = pgTable(
 ...
 */
export const universeFundamentals = pgTable(
 ...
 */
export const universeTechnicals = pgTable(
  "universe_technicals",
  {
    id: varchar("id")
      .primaryKey()
  ...
  (table) => [
    ...
    unique("universe_technicals_symbol_date_unique").on(
      table.symbol,
      table.date
    ),
  ]
 ...
 */
export const universeCandidates = pgTable(
  "universe_candidates",
  {
    id: varchar("id")
      .primaryKey()
...
export const insertUniverseAssetSchema = createInsertSchema(
  universeAssets
).omit({
  id: true,
...
export const insertUniverseLiquiditySchema = createInsertSchema(
...
export const insertUniverseFundamentalsSchema = createInsertSchema(
...
export const insertUniverseTechnicalsSchema = createInsertSchema(
  universeTechnicals
).omit({
  id: true,
  lastUpdatedAt: true,
...
export const insertAssetClassificationSchema = createInsertSchema(
...
export const insertUniverseCandidateSchema = createInsertSchema(
  universeCandidates
).omit({
  id: true,
  createdAt: true,
...
export type InsertUniverseLiquidity = z.infer<
  typeof insertUniverseLiquiditySchema
>;
export type UniverseLiquidity = typeof universeLiquidityMetrics.$inferSelect;

export type InsertUniverseFundamentals = z.infer<
  typeof insertUniverseFundamentalsSchema
>;
export type UniverseFundamentals = typeof universeFundamentals.$inferSelect;

export type InsertUniverseTechnicals = z.infer<
  typeof insertUniverseTechnicalsSchema
>;
export type UniverseTechnicals = typeof universeTechnicals.$inferSelect;

export type InsertAssetClassification = z.infer<
  typeof insertAssetClassificationSchema
>;
export type AssetClassification = typeof assetClassifications.$inferSelect;

export type InsertUniverseCandidate = z.infer<
  typeof insertUniverseCandidateSchema
>;
