...
describe('NotificationService', () => {
  ...
  describe('Channel Management', () => {
    ...
    it('should update an existing channel', () => {
      ...
      registerChannel(channel);
      const updated = updateChannel('test-channel-2', { name: 'Updated Name', enabled: false });
  ...
  describe('Template Management', () => {
    ...
    it('should have default templates', () => {
      const templates = getTemplates();
      const tradeOrderFilled = templates.find(t => t.id === 'trade-order-filled');
  ...
  describe('Notification Sending', () => {
    ...
    it('should send notification to Discord channel', async () => {
      ...
      const result = await sendDirectNotification('discord-test', 'Test message');
