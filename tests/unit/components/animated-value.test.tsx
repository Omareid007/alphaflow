...
describe("AnimatedValue Component", () => {
  describe("Basic Rendering", () => {
    it("renders the value", () => {
      ...
      // Value should be displayed (may be formatted)
  ...
  describe("Trend Detection", () => {
    it("detects positive trend", () => {
      render(<AnimatedValue value={100} previousValue={80} />);
      // Should have gain styling when value increased
      expect(document.body).toBeInTheDocument();
    });

    it("detects negative trend", () => {
      render(<AnimatedValue value={80} previousValue={100} />);
...
describe("AnimatedChange Component", () => {
  describe("Positive Change", () => {
    it("renders positive change with up arrow", () => {
      ...
      // Should show positive percentage with styling
      expect(document.body).toHaveTextContent(/5\.?2?5?/);
    });

    it("applies gain styling for positive values", () => {
      const { container } = render(<AnimatedChange value={10} />);
      // The component should have gain color styling
  ...
  describe("Formatting", () => {
    ...
    it("shows appropriate decimal places", () => {
      render(<AnimatedChange value={12.345} />);
      // Should round/truncate appropriately
      expect(document.body).toBeInTheDocument();
    });
  });
});
...
describe("AnimatedPortfolioValue Component", () => {
  describe("Basic Rendering", () => {
    ...
    it("renders change when provided", () => {
      render(<AnimatedPortfolioValue value={100000} change={2.5} />);
      expect(document.body).toHaveTextContent(/2\.?5?/);
      expect(document.body).toHaveTextContent("%");
    });
  });
  ...
  describe("Change Direction", () => {
    it("shows positive change with gain styling", () => {
      const { container } = render(
        <AnimatedPortfolioValue value={100000} change={5.0} />
      );
    ...
    it("shows negative change with loss styling", () => {
      const { container } = render(
        <AnimatedPortfolioValue value={95000} change={-5.0} />
      );
      expect(container).toBeInTheDocument();
    });
  ...
  describe("Optional Props", () => {
    it("renders without label", () => {
      render(<AnimatedPortfolioValue value={50000} />);
