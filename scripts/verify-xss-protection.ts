...
if (failed > 0) {
  ...
  console.log('Review the failed checks and ensure sanitization is properly implemented.');
  process.exit(1);
} else {
  console.log('\n✓ All checks passed!');
  console.log('XSS protection is properly implemented across all critical endpoints.');
  process.exit(0);
}
