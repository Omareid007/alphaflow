...
// Helper functions
function logTest(category: string, testName: string, passed: boolean, error?: string, details?: any, duration?: number) {
  totalTests++;
...
async function testAuthenticationEndpoints() {
  ...
  try {
    ...
    if (res.status === 200 && res.data.id) {
      ...
      logTest(category, 'POST /api/auth/signup (User 1)', true, undefined, undefined, duration);
    } else {
      logTest(category, 'POST /api/auth/signup (User 1)', false, 'No user ID in response', res.data, duration);
    }
  } catch (error) {
    logTest(category, 'POST /api/auth/signup (User 1)', false, sanitizeErrorMessage(error));
  }
  ...
  try {
    ...
    if (res.status === 200 && res.data.id) {
      ...
      logTest(category, 'POST /api/auth/signup (User 2)', true, undefined, undefined, duration);
    } else {
      logTest(category, 'POST /api/auth/signup (User 2)', false, 'No user ID in response', res.data, duration);
    }
  } catch (error) {
    logTest(category, 'POST /api/auth/signup (User 2)', false, sanitizeErrorMessage(error));
  }
  ...
  try {
    ...
    if (res.status === 200 && res.data.id) {
      logTest(category, 'POST /api/auth/login (valid credentials)', true, undefined, undefined, duration);
    } else {
      logTest(category, 'POST /api/auth/login (valid credentials)', false, 'Invalid response', res.data, duration);
    }
  } catch (error) {
    logTest(category, 'POST /api/auth/login (valid credentials)', false, sanitizeErrorMessage(error));
  }
  ...
  try {
    ...
    const duration = Date.now() - start;
    logTest(category, 'POST /api/auth/login (invalid credentials)', false, 'Should have failed but succeeded', res.data, duration);
  } catch (error) {
    if (axios.isAxiosError(error) && error.response?.status === 401) {
      logTest(category, 'POST /api/auth/login (invalid credentials)', true);
    } else {
      logTest(category, 'POST /api/auth/login (invalid credentials)', false, sanitizeErrorMessage(error));
    }
  }
  ...
  try {
    ...
    if (res.status === 200 && res.data.username === testUsers.user1.username) {
      logTest(category, 'GET /api/auth/me (authenticated)', true, undefined, undefined, duration);
    } else {
      logTest(category, 'GET /api/auth/me (authenticated)', false, 'Wrong user data', res.data, duration);
    }
  } catch (error) {
    logTest(category, 'GET /api/auth/me (authenticated)', false, sanitizeErrorMessage(error));
  }
  ...
  try {
    ...
    const duration = Date.now() - start;
    logTest(category, 'GET /api/auth/me (no auth)', false, 'Should have failed but succeeded', res.data, duration);
  } catch (error) {
    if (axios.isAxiosError(error) && error.response?.status === 401) {
      logTest(category, 'GET /api/auth/me (no auth)', true);
    } else {
      logTest(category, 'GET /api/auth/me (no auth)', false, sanitizeErrorMessage(error));
    }
  }
}
...
async function testProtectedEndpoints() {
  ...
  try {
    ...
    const duration = Date.now() - start;
    logTest(category, 'GET /api/strategies (no auth)', false, 'Should have failed but succeeded', undefined, duration);
  } catch (error) {
    if (axios.isAxiosError(error) && error.response?.status === 401) {
      logTest(category, 'GET /api/strategies (no auth)', true);
    } else {
      logTest(category, 'GET /api/strategies (no auth)', false, sanitizeErrorMessage(error));
    }
  }
  ...
  try {
    ...
    if (res.status === 200 && Array.isArray(res.data)) {
      logTest(category, 'GET /api/strategies (authenticated)', true, undefined, undefined, duration);
    } else {
      logTest(category, 'GET /api/strategies (authenticated)', false, 'Invalid response', res.data, duration);
    }
  } catch (error) {
    logTest(category, 'GET /api/strategies (authenticated)', false, sanitizeErrorMessage(error));
  }
  ...
  try {
    ...
    if (res.status === 200 && Array.isArray(res.data)) {
      logTest(category, 'GET /api/backtests (authenticated)', true, undefined, undefined, duration);
    } else {
      logTest(category, 'GET /api/backtests (authenticated)', false, 'Invalid response', res.data, duration);
    }
  } catch (error) {
    logTest(category, 'GET /api/backtests (authenticated)', false, sanitizeErrorMessage(error));
  }
  ...
  try {
    ...
    if (res.status === 200 && Array.isArray(res.data)) {
      logTest(category, 'GET /api/positions (authenticated)', true, undefined, undefined, duration);
    } else {
      logTest(category, 'GET /api/positions (authenticated)', false, 'Invalid response', res.data, duration);
    }
  } catch (error) {
    logTest(category, 'GET /api/positions (authenticated)', false, sanitizeErrorMessage(error));
  }
  ...
  try {
    ...
    if (res.status === 200 && Array.isArray(res.data)) {
      logTest(category, 'GET /api/orders (authenticated)', true, undefined, undefined, duration);
    } else {
      logTest(category, 'GET /api/orders (authenticated)', false, 'Invalid response', res.data, duration);
    }
  } catch (error) {
    logTest(category, 'GET /api/orders (authenticated)', false, sanitizeErrorMessage(error));
  }
  ...
  try {
    ...
    if (res.status === 200 && Array.isArray(res.data)) {
      logTest(category, 'GET /api/trades (authenticated)', true, undefined, undefined, duration);
    } else {
      logTest(category, 'GET /api/trades (authenticated)', false, 'Invalid response', res.data, duration);
    }
  } catch (error) {
    logTest(category, 'GET /api/trades (authenticated)', false, sanitizeErrorMessage(error));
  }
}
...
async function testStrategyManagement() {
  ...
  try {
    const start = Date.now();
    const res = await axios.post(`${API_BASE}/api/strategies`, {
      name: 'Test Strategy',
      type: 'omar',
      config: {
        symbols: ['AAPL'],
    ...
    if (res.status === 200 && res.data.id) {
      ...
      logTest(category, 'POST /api/strategies (create)', true, undefined, undefined, duration);
    } else {
      logTest(category, 'POST /api/strategies (create)', false, 'No strategy ID', res.data, duration);
    }
  } catch (error) {
    logTest(category, 'POST /api/strategies (create)', false, sanitizeErrorMessage(error));
  }
  ...
  if (strategyId) {
    try {
      ...
      if (res.status === 200 && res.data.id === strategyId) {
        logTest(category, 'GET /api/strategies/:id', true, undefined, undefined, duration);
      } else {
        logTest(category, 'GET /api/strategies/:id', false, 'Wrong strategy', res.data, duration);
      }
    } catch (error) {
      logTest(category, 'GET /api/strategies/:id', false, sanitizeErrorMessage(error));
    }
  }
  ...
  if (strategyId) {
    try {
      const start = Date.now();
      const res = await axios.put(`${API_BASE}/api/strategies/${strategyId}`, {
      ...
      if (res.status === 200 && res.data.name === 'Updated Test Strategy') {
        logTest(category, 'PUT /api/strategies/:id (update)', true, undefined, undefined, duration);
      } else {
        logTest(category, 'PUT /api/strategies/:id (update)', false, 'Update failed', res.data, duration);
      }
    } catch (error) {
      logTest(category, 'PUT /api/strategies/:id (update)', false, sanitizeErrorMessage(error));
    }
  }
  ...
  if (strategyId) {
    try {
      const start = Date.now();
      const res = await axios.delete(`${API_BASE}/api/strategies/${strategyId}`, {
        headers: { Authorization: `Bearer ${testUsers.user1.token}` }
      });
      const duration = Date.now() - start;

      if (res.status === 200) {
        logTest(category, 'DELETE /api/strategies/:id', true, undefined, undefined, duration);
      } else {
        logTest(category, 'DELETE /api/strategies/:id', false, 'Delete failed', res.data, duration);
      }
    } catch (error) {
      logTest(category, 'DELETE /api/strategies/:id', false, sanitizeErrorMessage(error));
    }
  }
}
...
async function testDatabaseCRUD() {
  ...
  try {
    ...
    if (user && user.username === testUsers.user1.username) {
      ...
      logTest(category, 'getUserByUsername (User 1)', false, 'User not found or wrong data', user);
    }
  } catch (error) {
    logTest(category, 'getUserByUsername (User 1)', false, sanitizeErrorMessage(error));
  }
  ...
  try {
    ...
    if (user) {
      ...
      if (strategy && strategy.userId === user.id) {
        ...
        logTest(category, 'createStrategy with userId', false, 'UserId not set', strategy);
      }
    }
  } catch (error) {
    logTest(category, 'createStrategy with userId', false, sanitizeErrorMessage(error));
  }
    ...
    try {
      ...
      if (user) {
        ...
        if (found) {
          ...
          logTest(category, 'getStrategies filtered by userId', false, 'Strategy not found', strategies);
        }
      }
    } catch (error) {
      logTest(category, 'getStrategies filtered by userId', false, sanitizeErrorMessage(error));
    }
  }
  ...
  if (testStrategyId) {
    try {
      ...
      if (!strategy) {
        ...
        logTest(category, 'deleteStrategy', false, 'Strategy still exists', strategy);
      }
    } catch (error) {
  ...
  if (user1Id && user2Id) {
    try {
      ...
      if (strategy1 && strategy2) {
        ...
        logTest(category, 'Create strategies for both users', false, 'Strategy creation failed');
      }
    } catch (error) {
      logTest(category, 'Create strategies for both users', false, sanitizeErrorMessage(error));
    }
  }
  ...
  if (user1Id && user2Id && strategy2Id) {
    try {
      ...
      if (!found) {
        ...
        logTest(category, 'User 1 cannot see User 2 strategies', false, 'Data leak detected', found);
      }
    } catch (error) {
      logTest(category, 'User 1 cannot see User 2 strategies', false, sanitizeErrorMessage(error));
    }
  }
  ...
  if (user1Id && user2Id && strategy1Id) {
    try {
      ...
      if (!found) {
        ...
        logTest(category, 'User 2 cannot see User 1 strategies', false, 'Data leak detected', found);
      }
    } catch (error) {
      logTest(category, 'User 2 cannot see User 1 strategies', false, sanitizeErrorMessage(error));
    }
  }
...
async function testSessionManagement() {
  ...
  try {
    ...
    if (res.data.token) {
      ...
      logTest(category, 'Login creates session token', false, 'No token returned');
    }
  } catch (error) {
    logTest(category, 'Login creates session token', false, sanitizeErrorMessage(error));
  }
    ...
    try {
      ...
      if (user) {
        ...
        if (session && session.userId === user.id) {
          ...
          logTest(category, 'Session exists in database', false, 'Session not found or wrong userId', session);
        }
      }
    } catch (error) {
      logTest(category, 'Session exists in database', false, sanitizeErrorMessage(error));
    }
  }
  ...
  if (sessionToken) {
    try {
      ...
      if (res.status === 200 && res.data.username === testUsers.user1.username) {
        ...
        logTest(category, 'Session retrieval on authenticated request', false, 'Wrong user or status', res.data);
      }
    } catch (error) {
      logTest(category, 'Session retrieval on authenticated request', false, sanitizeErrorMessage(error));
    }
  }
  ...
  try {
    ...
    logTest(category, 'Invalid session token rejected', false, 'Should have failed but succeeded');
  } catch (error) {
    if (axios.isAxiosError(error) && error.response?.status === 401) {
      logTest(category, 'Invalid session token rejected', true);
    } else {
      logTest(category, 'Invalid session token rejected', false, sanitizeErrorMessage(error));
    }
  }
}
...
async function testInputSanitization() {
  ...
  try {
    ...
    if (res.data.user && !res.data.user.username.includes('<script>')) {
      ...
      logTest(category, 'XSS in username stripped', false, 'Script tags not stripped', res.data.user);
    }
  } catch (error) {
    logTest(category, 'XSS in username stripped', false, sanitizeErrorMessage(error));
  }
  ...
  try {
    ...
    if (res.data && !res.data.name.includes('<img')) {
      ...
      logTest(category, 'XSS in strategy name stripped', false, 'HTML tags not stripped', res.data);
    }
  } catch (error) {
    logTest(category, 'XSS in strategy name stripped', false, sanitizeErrorMessage(error));
  }
...
async function testBackgroundJobs() {
  ...
  try {
    ...
    logTest(category, 'Session cleanup job (manual check required)', true, 'Check server logs for job execution');
  } catch (error) {
    logTest(category, 'Session cleanup job', false, sanitizeErrorMessage(error));
  }
  ...
  try {
    ...
    if (res.status === 200) {
      ...
      logTest(category, 'Position reconciliation endpoint accessible', false, 'Unexpected status');
    }
  } catch (error) {
    logTest(category, 'Position reconciliation endpoint accessible', false, sanitizeErrorMessage(error));
  }
  ...
  try {
    ...
    if (res.status === 200) {
      ...
      logTest(category, 'Order reconciliation endpoint accessible', false, 'Unexpected status');
    }
  } catch (error) {
    logTest(category, 'Order reconciliation endpoint accessible', false, sanitizeErrorMessage(error));
  }
}
...
async function testErrorHandling() {
  ...
  try {
    ...
    logTest(category, 'Invalid credentials error (401)', false, 'Should have failed');
  } catch (error) {
    if (axios.isAxiosError(error) && error.response?.status === 401) {
      logTest(category, 'Invalid credentials error (401)', true);
    } else {
      logTest(category, 'Invalid credentials error (401)', false, sanitizeErrorMessage(error));
    }
  }

  // Test 2: Malformed request body
  try {
    await axios.post(`${API_BASE}/api/strategies`, {
      // Missing required fields
      name: 'Test'
    }, {
      headers: { Authorization: `Bearer ${testUsers.user1.token}` }
    });
    logTest(category, 'Malformed request error (400)', false, 'Should have failed');
  } catch (error) {
    if (axios.isAxiosError(error) && (error.response?.status === 400 || error.response?.status === 422)) {
      ...
      logTest(category, 'Malformed request error (400)', false, sanitizeErrorMessage(error));
    }
  }
  ...
  try {
    ...
    logTest(category, 'Non-existent resource error (404)', false, 'Should have failed');
  } catch (error) {
    if (axios.isAxiosError(error) && error.response?.status === 404) {
      logTest(category, 'Non-existent resource error (404)', true);
    } else {
      logTest(category, 'Non-existent resource error (404)', false, sanitizeErrorMessage(error));
    }
  }
  ...
  try {
    ...
    logTest(category, 'Duplicate user error (409)', false, 'Should have failed');
  } catch (error) {
    if (axios.isAxiosError(error) && (error.response?.status === 409 || error.response?.status === 400)) {
      ...
      logTest(category, 'Duplicate user error (409)', false, sanitizeErrorMessage(error));
    }
  }
}
...
async function testPerformance() {
  ...
  try {
    ...
    if (avgTime < 500) {
      logTest(category, 'GET /api/strategies response time', true, undefined, `Average: ${avgTime.toFixed(2)}ms`);
    } else {
      logTest(category, 'GET /api/strategies response time', false, `Too slow: ${avgTime.toFixed(2)}ms (should be < 500ms)`);
    }
  } catch (error) {
    logTest(category, 'GET /api/strategies response time', false, sanitizeErrorMessage(error));
  }
  ...
  try {
    ...
    if (user) {
      ...
      if (duration < 200) {
        logTest(category, 'Database query performance', true, undefined, `${duration}ms`);
      } else {
        logTest(category, 'Database query performance', false, `Too slow: ${duration}ms (should be < 200ms)`);
      }
    }
  } catch (error) {
    logTest(category, 'Database query performance', false, sanitizeErrorMessage(error));
  }
  ...
  try {
    ...
    if (duration < 2000) {
      logTest(category, 'Concurrent requests (10 parallel)', true, undefined, `${duration}ms total`);
    } else {
      logTest(category, 'Concurrent requests (10 parallel)', false, `Too slow: ${duration}ms (should be < 2000ms)`);
    }
  } catch (error) {
    logTest(category, 'Concurrent requests (10 parallel)', false, sanitizeErrorMessage(error));
  }
}
...
async function testAlpacaIntegration() {
  ...
  try {
    ...
    if (res.status === 200) {
      ...
      logTest(category, 'GET /api/alpaca/account', false, 'Unexpected status', res.data);
    }
  } catch (error) {
    // It's OK if Alpaca is not configured, just log it
    if (axios.isAxiosError(error) && error.response?.status === 503) {
      logTest(category, 'GET /api/alpaca/account', true, 'Alpaca not configured (expected)');
    } else {
      logTest(category, 'GET /api/alpaca/account', false, sanitizeErrorMessage(error));
    }
  }
  ...
  try {
    ...
    if (res.status === 200) {
      ...
      logTest(category, 'GET /api/alpaca/positions', false, 'Unexpected status', res.data);
    }
  } catch (error) {
    if (axios.isAxiosError(error) && error.response?.status === 503) {
      logTest(category, 'GET /api/alpaca/positions', true, 'Alpaca not configured (expected)');
    } else {
      logTest(category, 'GET /api/alpaca/positions', false, sanitizeErrorMessage(error));
    }
  }
  ...
  try {
    ...
    if (res.status === 200) {
      ...
      logTest(category, 'GET /api/alpaca/orders', false, 'Unexpected status', res.data);
    }
  } catch (error) {
    if (axios.isAxiosError(error) && error.response?.status === 503) {
      logTest(category, 'GET /api/alpaca/orders', true, 'Alpaca not configured (expected)');
    } else {
      logTest(category, 'GET /api/alpaca/orders', false, sanitizeErrorMessage(error));
    }
  }
}
...
async function testDataIntegrity() {
  ...
  try {
    ...
    if (user) {
      ...
      if (strategy && strategy.userId === user.id) {
        ...
        logTest(category, 'Foreign key constraint on strategies', false, 'UserId not set correctly');
      }
    }
  } catch (error) {
    logTest(category, 'Foreign key constraint on strategies', false, sanitizeErrorMessage(error));
  }
  ...
  try {
    ...
    logTest(category, 'Unique constraint on username', false, 'Duplicate username allowed');
  } catch (error) {
  ...
  try {
    ...
    logTest(category, 'Unique constraint on email', false, 'Duplicate email allowed');
  } catch (error) {
    // Error is expected - unique constraint working
...
function generateMarkdownReport(totalTime: number): string {
  ...
  categories.forEach(category => {
    ...
    categoryResults.forEach(r => {
      ...
      const details = r.error || (r.details ? JSON.stringify(r.details).substring(0, 50) : '-');
  ...
  if (failedTests === 0) {
    ...
    const failedCategories = [...new Set(results.filter(r => !r.passed).map(r => r.category))];
    failedCategories.forEach(category => {
      const failed = results.filter(r => !r.passed && r.category === category);
