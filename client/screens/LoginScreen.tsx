  ...
  return (
    ...
    >
      <View style={styles.header}>
        ...
        <ThemedText style={styles.title}>AI Active Trader</ThemedText>
      ...
      <Card elevation={1} style={styles.formCard}>
        ...
        {loginError ? (
          <View style={styles.errorContainer}>
            ...
            <ThemedText style={[styles.errorText, { color: BrandColors.error }]}>{loginError}</ThemedText>
          </View>
        ) : null}
      ...
      <View style={styles.footer}>
        ...
        <Pressable onPress={onSwitchToSignup}>
          <ThemedText style={[styles.linkText, { color: BrandColors.primaryLight }]}>Sign Up</ThemedText>
        </Pressable>
      </View>
    </KeyboardAwareScrollViewCompat>
  );
